# Generated by Django 3.2.10 on 2023-08-12 12:01
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('dbf_file', models.FileField(upload_to='Spatial_Files57826')),
                ('shp_file', models.FileField(upload_to='Spatial_Files57826')),
                ('shx_file', models.FileField(upload_to='Spatial_Files57826')),
